...
public interface ISysUserService {
	 ...
	 *
	 * @param userId 用户id
	 * @return ${package}.system.entity.SysUserDo
	 * @since 2021/2/4
	 */
	 ...
	 * @return com.easy.archetype.framework.core.page.PageInfo<${package}.system.entity.SysUserDo>
	 * @since 2021/2/11
	 */
	 ...
	 *
	 * @param userId 用户id
	 * @return ${package}.system.vo.SysUserVo
	 * @since 2021/2/15
	 */
	 ...
	 *
	 * @param userId 用户id
	 * @return java.util.List<${package}.system.entity.SysMenuDo>
	 * @since 2021/4/22
	 */
