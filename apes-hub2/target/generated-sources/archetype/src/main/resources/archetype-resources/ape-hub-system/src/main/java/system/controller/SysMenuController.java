...
import ${package}.system.vo.RouterVo;
...
public class SysMenuController {
	 ...
	 *
	 * @param menu 条件
	 * @return com.easy.archetype.framework.core.page.RespEntity<java.util.List < ${package}.system.entity.SysMenuDo>>
	 * @since 2021/2/14
	 */
...
//		List<SysMenuDo> sysMenuDos = sysMenuService.listByUserId(menu, userId);
	 ...
	 *
	 * @param menu
	 * @return com.easy.archetype.framework.core.page.RespEntity<java.util.List < ${package}.system.vo.TreeSelectVo>>
	 * @since 2021/2/14
	 */
